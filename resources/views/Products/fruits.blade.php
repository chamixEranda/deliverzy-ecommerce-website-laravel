...
@section('title', 'Categories-Fruits - ')
    
@section('content')
    <section style="padding-top: 80px">
        <div class="container">
            <h2 class="text">Fruits</h2>
        </div>
                  ...
                  @foreach ($product as $oneproduct)
                     <div class="col-md-2 mt-4 ms-4 ">             
                        ...
                        @endauth
                            ...
                            <a href="{{ route('ShowProduct',$oneproduct->id) }}"><img src="{{ asset('productImages/'.$oneproduct->imagepath) }}" class="card-img-top " height="120px"></a>
                            <div class="card-body">
