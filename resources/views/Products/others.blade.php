...
@section('title', 'Categories-Others - ')
    
@section('content')
    <div class="container">
        <h2 class="text">Others</h2>
    </div>
              ...
              @foreach ($product as $oneproduct)
                 <div class="col-md-2 mt-4 ms-4 ">             
                    ...
                    @endauth
                        ...
                        <a href="{{ route('ShowProduct',$oneproduct->id) }}"><img src="{{ asset('productImages/'.$oneproduct->imagepath) }}" class="card-img-top " height="90px"></a>
                        <div class="card-body">
